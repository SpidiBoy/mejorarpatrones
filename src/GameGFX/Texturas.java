...
public class Texturas {
    ...
    // 🔥 FIX: Separación de counts
    private final int corazones_count = 2;        // 2 sprites: corazón normal y roto
    private final int dk_agarra_count = 6;        // 6 frames de animación (48x40)
    
    private CargadorImagenes cargar;
    
    // HOJAS DE SPRITES GLOBALES
    private BufferedImage player_sheet, enemy_sheet, barril_sheet;
    ...
    // 🔥 FIX: Arrays separados para victoria
    private BufferedImage spriteCorazon;
    private BufferedImage spriteCorazonRoto;
    private BufferedImage[] spritesDKAgarra;      // Array de 6 frames (48x40)
    ...
    /**
     * COMPLETO: Carga sprites de victoria correctamente
     */
